  ...
  return (
    <div class="settings-section">
      ...
      <div class="settings-field-stack">
        <label class="settings-form-field"><span>Compute host address <em>mobile / remote</em></span><input value={props.url} onInput={(event) => props.onUrl(event.currentTarget.value)} placeholder="https://spark.example.com" type="url" inputMode="url" autocapitalize="none" autocorrect="off" spellcheck={false} /><small>Use the HTTPS address for the computer that runs your Amplifier sessions.</small></label>
